...
export default function News() {
  ...
  const handlesignup = async (e) => {
    ...
    e.preventDefault();
    const { username, fname,prize, lname, address, password, email, PhoneNumber,delivery_time} =data;
    const res = await fetch("/newspaperregister", {
      method: "POST",
      headers: {
  ...
  const dev =<div class="form-group"><div class="form-group">Delivery time :- <input type="time" id="delivery_time" onChange={handlechange} value={data.delivery_time} name="delivery_time" min="07:00" max="11:00" required></input></div></div> ;

  return (
    <div class="main">
      <section class="signup">
        <div>News Provider</div>
        <div
          class="container"
